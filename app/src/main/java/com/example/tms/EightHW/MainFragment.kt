...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        button_add_phone.setOnClickListener {
            ...
            if (!switchFragment(addPhoneFragment) && validateTextFields(editTexts,editTextLayouts)) {
                CollectionPhones.wasUpdated = true
                val phone = Phone(
                ...
                launchIO {
                    try {
                        context
                            ?.let { PhoneDB.getDataBase(it).phoneDao() }
                            ?.insertPhone(phone)
                        launchUI {
                        ...
                        launchUI {
                            Toast.makeText(context, "This phone already in list", Toast.LENGTH_SHORT).show()
                        }
                    }
                }
            ...
            button_show_phones.setOnClickListener {
                if (CollectionPhones.wasUpdated) {
                    launchIO {
                    ...
                    CollectionPhones.wasUpdated = false
                }
    ...
    private fun validateTextFields(editTexts:List<TextInputEditText?>, editTextLayouts:List<TextInputLayout?>):Boolean {
